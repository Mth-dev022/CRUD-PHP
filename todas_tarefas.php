	...
	<head>
		...
		<script>
			...
			function editar (id, taref) {
				...
				//INCLUIR O INPUT HIDDEN NO FORM
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								foreach($tarefas as $indicie => $tarefa) { ?>
									...
									<i onclick="remover(<?=$tarefa->id?>)" class="fas fa-trash-alt fa-lg text-danger"></i>
										...
										<?php if($tarefa->status == 'pendente') { ?>
											...
											<i onclick="realizar(<?=$tarefa->id?>)" class="fas fa-check-square fa-lg text-success"></i> <?php } ?>
